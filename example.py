...
سلام نام من جیسون محمدنژادپوراست و در میامی  زندگی میکنم. شماره کارت اعتباری من 6104337958646987 است که از آن به حساب شما پول می‌ریزم. من سایت microsof.com رو مشاهده کردم و ایمیل کارمند مایکروسافت، akabr@micr.com، را برداشتم.
